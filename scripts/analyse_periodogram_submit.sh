...
# Injection
srun python analyse_periodogram.py --start_time ${1} --end_time ${2} --data_source injection --injection_id ${3} --injection_mode general_qpo --recovery_mode ${4} --window ${5} --frequency_mask_minimum 0.025 --run_mode select_time --injection_file_dir injection_files_pop --injection_likelihood_model whittle --likelihood_model whittle --band_minimum 0.025 --band_maximum 40 --sample rslice --nlive 1000 --try_load False --resume False
