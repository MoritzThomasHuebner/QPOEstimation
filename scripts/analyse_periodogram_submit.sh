...
# Solar Flare
srun python analyse_periodogram.py --start_time ${1} --end_time ${2} --data_source solar_flare --solar_flare_folder goes --solar_flare_id go1520130512 --recovery_mode ${3} --window hann --run_mode select_time --likelihood_model whittle --normalisation True --sample rslice --nlive 500 --try_load False --resume False
