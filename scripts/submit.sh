...
#srun python sliding_window.py --run_id ${1} --period_number ${2} --n_qpos 0 --model ${3} --band_minimum ${4} --band_maximum ${5} --suffix _0.5s --segment_length 0.5
#srun python sliding_window.py --run_id ${1} --period_number ${2} --n_qpos 1 --model ${3} --band_minimum ${4} --band_maximum ${5} --suffix _0.5s --segment_length 0.5
...
# Candidate runs
srun python sliding_window.py --candidates_run True --candidate_id ${1} --n_qpos 0 --model ${2} --plot True --band_minimum ${3} --band_maximum ${4} --suffix _0.5s
srun python sliding_window.py --candidates_run True --candidate_id ${1} --n_qpos 1 --model ${2} --plot True --band_minimum ${3} --band_maximum ${4} --suffix _0.5s
