...
samples = []
outdir_qpo_qpo = get_injection_outdir(injection_mode='general_qpo', recovery_mode='general_qpo',
                                      likelihood_model='gaussian_process', base_injection_outdir='injection_mss')
outdir_qpo_qpo = f"{outdir_qpo_qpo}/results"
outdir_qpo_red_noise = get_injection_outdir(injection_mode='general_qpo', recovery_mode='red_noise',
                                      likelihood_model='gaussian_process', base_injection_outdir='injection_mss')
outdir_qpo_red_noise = f"{outdir_qpo_red_noise}/results"
outdir_red_noise_red_noise = get_injection_outdir(injection_mode='red_noise', recovery_mode='red_noise',
                                      likelihood_model='gaussian_process', base_injection_outdir='injection_mss')
outdir_red_noise_red_noise = f"{outdir_red_noise_red_noise}/results"
outdir_red_noise_qpo = get_injection_outdir(injection_mode='red_noise', recovery_mode='general_qpo',
                                            likelihood_model='gaussian_process', base_injection_outdir='injection_mss')
...
plt.hist(ln_bfs_qpo_inj, alpha=0.5, density=True, bins='fd')
plt.hist(ln_bfs_red_noise_inj, alpha=0.5, density=True, bins='fd')
plt.semilogy()
