...
srun python analyse.py --data_source solar_flare --solar_flare_id ${1} --run_mode select_time --recovery_mode ${2}  --likelihood_model gaussian_process --band_minimum 0.001 --band_maximum 1 --variance_stabilisation False --background_model ${3} --n_components ${4} --plot True --nlive 500 --sample rwalk --start_time ${5} --end_time ${6}  --amplitude_min 10 --amplitude_max 1e8 --skewness_min 0.1 --skewness_max 10000 --sigma_min 0.1 --sigma_max 1000 --t_0_min 0 --t_0_max 2000 --min_log_a -30 --max_log_a 30
