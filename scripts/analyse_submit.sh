...
srun python analyse.py --data_source giant_flare --run_mode select_time --likelihood_model ${2} --recovery_mode ${1} --start_time ${3} --end_time ${4} --background_model skew_gaussian --n_components 1 --offset True --plot True --nlive 500 --sample rslice --min_log_a 0 --max_log_a 10 --resume True --try_load True --sampling_frequency 128
