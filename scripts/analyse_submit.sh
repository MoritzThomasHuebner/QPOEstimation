...
srun python analyse.py  --run_mode candidates --candidate_id ${1} --recovery_mode red_noise --model gaussian_process --band_minimum 5 --band_maximum 64 --background_model polynomial --polynomial_max 1000 --data_mode normal --segment_length 1 --plot True --try_load True
srun python analyse.py  --run_mode candidates --candidate_id ${1} --recovery_mode qpo --model gaussian_process --band_minimum 5 --band_maximum 64 --background_model polynomial --polynomial_max 1000 --data_mode normal --segment_length 1 --plot True --try_load True
