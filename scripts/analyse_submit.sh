...
srun python analyse.py  --run_id ${1} --period_number ${2} --recovery_mode qpo --model ${5} --band_minimum ${3} --band_maximum ${4} --background_model polynomial --data_mode normal --segment_length 1.8 --segment_step 0.23625 --plot True
...
srun python analyse.py  --run_id ${1} --period_number ${2} --recovery_mode red_noise --model ${5} --band_minimum ${3} --band_maximum ${4} --background_model polynomial --data_mode normal --segment_length 1.8 --segment_step 0.23625 --plot True
