...
srun python analyse.py --data_source injection --run_mode entire_segment --injection_id ${1} --injection_mode ${2} --base_injection_outdir injections --injection_file_dir injection_files_mss_with_mean --injection_likelihood_model celerite --recovery_mode ${3} --likelihood_model celerite --plot False --nlive 500 --sample rslice --offset False --min_log_a -4 --max_log_a 4 --min_log_c_red_noise -1 --max_log_c_red_noise 3 --min_log_c_qpo -1 --max_log_c_qpo 3 --amplitude_min 0 --amplitude_max 10 --likelihood_model celerite --background_model 0 --sampling_frequency 256 --band_minimum 1 --band_maximum 64 --plot True
