...
srun python analyse.py  --run_id ${1} --period_number ${2} --recovery_mode white_noise --model gaussian_process --band_minimum ${3} --band_maximum ${4} --background_model mean --data_mode smoothed_residual --segment_length 1.8 --segment_step 0.23625 --plot False --try_load True
srun python analyse.py  --run_id ${1} --period_number ${2} --recovery_mode qpo --model gaussian_process_windowed --band_minimum ${3} --band_maximum ${4} --background_model mean --data_mode smoothed_residual --segment_length 1.8 --segment_step 0.23625 --plot False --try_load True
srun python analyse.py  --run_id ${1} --period_number ${2} --recovery_mode red_noise --model gaussian_process_windowed --band_minimum ${3} --band_maximum ${4} --background_model mean --data_mode smoothed_residual --segment_length 1.8 --segment_step 0.23625 --plot False --try_load True
srun python analyse.py  --run_id ${1} --period_number ${2} --recovery_mode mixed --model gaussian_process_windowed --band_minimum ${3} --band_maximum ${4} --background_model mean --data_mode smoothed_residual --segment_length 1.8 --segment_step 0.23625 --plot False --try_load True
#
