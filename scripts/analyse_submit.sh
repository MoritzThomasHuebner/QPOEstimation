...
srun python analyse.py --data_source injection --run_mode entire_segment --injection_id ${1} --injection_mode ${2} --base_injection_outdir injetion_pp --injection_file_dir injection_files --injection_likelihood_model gaussian_process --recovery_mode ${3} --likelihood_model gaussian_process --background_model 0 --plot True --nlive 500 --sample rslice --offset False --amplitude_min 10 --amplitude_max 100 --sigma_min 0.1 --sigma_max 1 --t_0_min 0 --t_0_max 2 --min_log_a -1 --max_log_a 1 --min_log_c -1 --max_log_c 1 --likelihood_model gaussian_process --background_model skew_gaussian --n_components 1 --segment_length 2 --sampling_frequency 256 --band_minimum 1 --band_maximum 64 --plot True
