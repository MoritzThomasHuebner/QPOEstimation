...
#srun python analyse.py --data_source hares_and_hounds --run_mode from_maximum  --hares_and_hounds_id ${1} --hares_and_hounds_round HH2  --likelihood_model ${2} --recovery_mode ${3} --n_components ${4} --background_model ${5} --sample rwalk --nlive 2000 --use_ratio False --try_load False --resume False --plot True --offset True --jitter_term True --sampling_frequency 1
...
# Solar Flare
#srun python analyse.py --start_time 74700 --end_time 74900 --data_source solar_flare --solar_flare_folder goes --solar_flare_id go1520130512 --recovery_mode ${1} --run_mode select_time --likelihood_model gaussian_process --normalisation True --sample rwalk --nlive 1000 --n_components ${2} --jitter_term True --try_load False --resume True --polynomial_max 2
