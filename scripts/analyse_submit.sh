...
srun python analyse.py  --run_id ${1} --period_number ${2} --recovery_mode qpo --model gaussian_process --band_minimum 10 --band_maximum 64 --background_model mean --data_mode smoothed_residual --segment_length 3 --segment_step 1.08
srun python analyse.py  --run_id ${1} --period_number ${2} --recovery_mode red_noise --model gaussian_process --band_minimum 10 --band_maximum 64 --background_model mean --data_mode smoothed_residual --segment_length 3 --segment_step 1.08
