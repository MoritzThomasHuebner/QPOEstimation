...
for red_noise_evidences, qpo_evidences, label in zip(
        [evidence_qpo_1_skew_exponential_list, evidence_qpo_2_skew_exponential_list, evidence_qpo_3_skew_exponential_list],
...
for ln_bfs, label in zip(
        [ln_bfs_1_skew_exponential, ln_bfs_2_skew_exponential, ln_bfs_3_skew_exponential],
        ["1_skew_exponentials", "2_skew_exponentials", "3_skew_exponentials"]):
