...
from QPOEstimation.model.celerite import get_n_component_skew_exponential_model
from QPOEstimation.likelihood import get_kernel
from QPOEstimation.injection import InjectionCreator
import json

with open('SolarFlare/120704187/results/skew_exponential_1_result.json') as f:
    ref_res = json.load(f)

# ref_res = bilby.result.read_in_result('SolarFlare/120704187/results/initial_test_skew_exponential_3_result.json')
...
mean_model = get_n_component_skew_exponential_model(n_exps=3)
...
creator = InjectionCreator(params=max_like_params, injection_mode='qpo', times=times,
                           outdir='solar_flare_injection', injection_id='1_skew_exponential_injection', likelihood_model='gaussian_process', mean_model=mean_model,
                           poisson_data=True)
