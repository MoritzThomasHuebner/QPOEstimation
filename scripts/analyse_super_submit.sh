...
#    sbatch analyse_submit.sh $segment $period 128 256 gaussian_process
    sbatch analyse_submit.sh $segment $period 5 64 gaussian_process_windowed white_noise
...
#    sbatch analyse_submit.sh $segment $period 5 64 gaussian_process_windowed mixed
    sbatch analyse_submit.sh $segment $period 64 128 gaussian_process_windowed white_noise
